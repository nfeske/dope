...
static void print_prompt(void) {
	snprintf((char *)(cbuf_adr + curs_y*TERM_W), 100, "DOpE>");
 ...
 */
static void press_callback(Event_union *e,void *arg) {
	static char res[256];
	char nc;
...
void init_dopecmd(void)
{
	...
	cbuf_adr = (char *)vscr_get_fb(app_id, "vts");
