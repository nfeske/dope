 ...
 */
static void set_trans_callback(Event_union *e, void *arg)
{
 ...
 */
static void set_shadows_callback(Event_union *e, void *arg)
{
 ...
 */
static void reset_callback(Event_union *e, void *arg)
{
 ...
 */
static void set_colors_callback(Event_union *e, void *arg)
{
	unsigned long r, g, b;
 ...
 */
static void set_redraw_granularity_callback(Event_union *e, void *arg)
{
	unsigned long v;
 ...
 */
static void close_callback(Event_union *e, void *arg)
{
...
void init_settings(void)
{
	...
	dope_cmd_seq(app_id,
		...
		"redraw_scale = new Scale(-from 2 -to 1000 -variable redraw_var)",
	...
	dope_bind(app_id, "desk_r_scale", "change", set_colors_callback, nullptr);
	dope_bind(app_id, "desk_g_scale", "change", set_colors_callback, nullptr);
	dope_bind(app_id, "desk_b_scale", "change", set_colors_callback, nullptr);
	dope_bind(app_id, "win_r_scale",  "change", set_colors_callback, nullptr);
	dope_bind(app_id, "win_g_scale",  "change", set_colors_callback, nullptr);
	dope_bind(app_id, "win_b_scale",  "change", set_colors_callback, nullptr);
	dope_bind(app_id, "redraw_scale", "change", set_redraw_granularity_callback, nullptr);
	...
	dope_bind(app_id, "reset", "commit", reset_callback, nullptr);
	dope_bind(app_id, "w",     "close",  close_callback, nullptr);
}
